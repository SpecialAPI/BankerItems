...
namespace BankerItems.ItemAPI
{
    public static class SpriteBuilder
    {
        ...
        public static tk2dSprite baseSprite = PickupObjectDatabase.GetById(155).GetComponent<tk2dSprite>();
        ...
        public static tk2dSpriteDefinition ConstructDefinition(Texture2D texture, string shaderName = null)
        {
            ...
            Material material = new Material(ShaderCache.Acquire(shaderName ?? PlayerController.DefaultShaderName));
